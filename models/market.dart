...
class Market {
  ...
  Market.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      whatsapp = jsonMap['whatsapp'] != null ? jsonMap['whatsapp'].toString() : '';
      facebook = jsonMap['facebook'] != null ? jsonMap['facebook'].toString() : '';;
      twitter = jsonMap['twitter'] != null ? jsonMap['twitter'].toString() : '';;
      youtube = jsonMap['youtube'] != null ? jsonMap['youtube'].toString() : '';;
      linkedin = jsonMap['linkedin'] != null ? jsonMap['linkedin'].toString() : '';;
