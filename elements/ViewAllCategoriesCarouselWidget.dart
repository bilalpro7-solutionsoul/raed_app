...
class ViewAllCategoryWidget extends StatefulWidget {
  final id ;
ViewAllCategoryWidget({this.id});

  @override
  _ViewAllCategoryWidgetState createState() => _ViewAllCategoryWidgetState();
}

class _ViewAllCategoryWidgetState extends StateMVC<ViewAllCategoryWidget> {
  // TODO add layout in configuration file
  String layout = 'grid';

  CategoryController _con;

  _ViewAllCategoryWidgetState() : super(CategoryController()) {
    _con = controller;
  }

  @override
  void initState() {
    _con.listenForProductsByCategory(id: widget.id);
