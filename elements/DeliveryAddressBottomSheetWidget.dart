...
class DeliveryAddressBottomSheetWidget extends StatefulWidget {
  ...
  // callback for update cart locations
  final Function callback;

  DeliveryAddressBottomSheetWidget({Key key, this.scaffoldKey, this.callback})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ModalProgressHUD(
        inAsyncCall: _gettingCurrentLocation,
        child: Stack(
          children: <Widget>[
            Padding(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      var result= await _con.changeDeliveryAddressToCurrentLocation();
                      _con.addAddress(result);
                      setState(() {
                        _gettingCurrentLocation = false;
                      });
                      await _con.changeDeliveryAddress(_con.addresses.last);
...
//                );
                      return InkWell(
                        onTap: () async {
                          await _con.changeDeliveryAddress(
