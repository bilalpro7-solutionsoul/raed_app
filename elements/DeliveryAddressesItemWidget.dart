...
class DeliveryAddressesItemWidget extends StatelessWidget {
                      ...
                      children: <Widget>[
                        Row(
                          children: [
                            ...
                            showEditLocation ? _setLocationBtn() : Container(),
                          ],
                        ),
                        // address?.description != null
                        //     ? Text(
  ...
  FlatButton _setLocationBtn() {
    return FlatButton(
      child: Text('Edit'),
      onPressed: () {
        con.scaffoldKey.currentState.showBottomSheet((context) {
          return DeliveryAddressBottomSheetWidget(
            scaffoldKey: con.scaffoldKey,
            callback: () => callback(),
            // callback: () => setState(() => print('SetStateNewX')),
          );
        });
