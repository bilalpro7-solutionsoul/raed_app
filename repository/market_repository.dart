...
Future<Stream<Market>> getNearMarkets(Address myLocation, Address areaLocation) async {
  ...
  // if (!myLocation.isUnknown() && !areaLocation.isUnknown()) {
    _queryParams['myLon'] =myLocation.longitude!=null? myLocation.longitude.toString():longitude;
    _queryParams['myLat'] =  myLocation.latitude!=null ?myLocation.latitude.toString():latitude;
    _queryParams['areaLon'] =areaLocation.longitude!=null? areaLocation.longitude.toString():longitude;
    _queryParams['areaLat'] = areaLocation.latitude!=null?areaLocation.latitude.toString():latitude;
  // }
...
Future<Stream<Market>> getAllMarkets(Address myLocation, Address areaLocation) async {
  Uri uri = Helper.getUri('api/all_markets');
  Map<String, dynamic> _queryParams = {};
  SharedPreferences prefs = await SharedPreferences.getInstance();
  Filter filter = Filter.fromJSON(json.decode(prefs.getString('filter') ?? '{}'));
