...
import 'package:markets/src/pages/intro_slider.dart';
...
import 'src/pages/addLocation.dart';
import 'src/pages/showAddress.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case'/showAd':
        return MaterialPageRoute(builder: (_) => ShowAddresses());
      case '/Splash':
